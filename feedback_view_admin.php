			...
			<div id="navbar" class="navbar-collapse collapse">
				...
				<h1 style="text-align: center;"> <a href="#" ><i aria-hidden="true"></i> Admin Page </a></h1>
					...
					<ul class="nav navbar-nav">
											   ...
											   <li class="active"><a  href="feedback_view_admin.php">FeedBack</a>
											   <li class="dropdown">
		...
		<div class="container">
			...
			<div class="inner_sec_info_wthree_agile">
                ...
                <script src="countries.js"> </script>
					<div class="login-form-rec" style="margin-left:170px;">
		   <?php 
		   $server="localhost";
		   $user="root";
		   $password="";
		   ...
		   ?>
		     <table width="747" border="1" align="center">
               <tr bgcolor="#0000FF">
                 ...
                 <td  bgcolor="#FF0000"><div style="color:#FFFFFF"><strong>Activity</strong></div></td>
               </tr>
               <?php
               ...
               <tr>
                 ...
                 <td><a href="feedback_del.php?id=<?php echo $row['complaint_id'];?>">Delete </a></td>
               </tr>
               <?php
			    }
			   ?>
