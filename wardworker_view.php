...
<div class="main">
	...
	<div class="registration">
		...
		<h2 align="left">&nbsp;</h2>
		<h2 align="left">Assigned WardWorker Details</h2>
		<!-- [if IE] 
		...
		<script>
		 ...
		 <!-- Form -->
		  ...
		  <table width="611" border="1" align="center">
            <tr>	
              <td bgcolor="#33FF99" style="color:#000000">Worker Name</td>
              <td bgcolor="#33FF99" style="color:#000000">Ward</td>
              <td bgcolor="#33FF99" style="color:#000000">Area</td> 
              <td bgcolor="#33FF99" style="color:#000000">Address</td>
              <td bgcolor="#33FF99" style="color:#000000">Contact</td>
              <td bgcolor="#33FF99" style="color:#000000">Email</td>
              <td bgcolor="#33FF99" style="color:#000000">Complaint ID</td>
              <td bgcolor="#33FF99" style="color:#000000">Status</td>
              <td bgcolor="#FF0000" style="color:#FFFFFF">Activity</td>
            </tr>
            <?php
