...
<ul class="nav navbar-nav">
			...
			<li><a href="assigned_worker_cmplnts.php">Forward Complaints</a>
				...
				<li class="active"><a  href="wardworker_details.php">Add Wardworkers</a>
...
<div class="banner_bottom">
		<div class="container">
		   ...
		   <form action="add_wardworker_details.php" method="post" >
  
  <table width="570" height="466" align="left">
  <tr>
    <td><div align="left">Worker Name</div></td>
    <td>
      <input type="text" name="t1" id="t1" style="width:200px;" />    </td>
  </tr>
  <tr>
    <td><div align="left">Ward</div></td>
    <td>
      <input type="text" name="t2" id="t2" style="width:200px;"   />    </td>
  </tr>
  <tr>
    <td><div align="left">Area</div></td>
    <td>
      <input type="text" name="t3" id="t3" style="width:200px;"  />    </td>
  </tr>
