...
<script type="text/javascript" src="//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script>
				...
				<ul class="nav navbar-nav">
					<li > <a href="authority_home.php">Home </a> </li>
							<li class="active"><a  href="areawise_view.php">AreaWise Complaints</a></li>
...
<div class="banner_bottom">
		<div class="container">
			<div class="tittle-w3ls_head">
				<h3 class="tittle-w3ls three">Area Wise Complaints<span></span></h3>
			</div>
			<div class="inner_sec_info_wthree_agile">
				<div class="signin-form">
		   <form action="areawise_view2.php" method="post">
           <?php
...
$con=mysqli_connect($server,$user,$password,$dbname);
		   ...
		   $ss="select distinct(area) from complaintdetails";
		   $rs=mysqli_query($con,$ss);
		   ?>
  
  <table width="570" height="154" align="center">
  <tr>
    <td width="184">Select Area</td>
    <td>
