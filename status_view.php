...
<div class="container">
	<div class="header">
		...
		<ul class="megamenu skyblue">
			<li><a class="color1" href="user_home.php">Home</a></li>
			<li class="grid"><a class="color2" href="#">Complaint Registration</a>
				
				</li>				
				<li><a class="color5" href="#">Check Status</a>
				
				</li>
                
                <li><a class="color5" href="#">Feedback</a>
...
<div class="main">
	...
	<div class="registration">
		...
		<h2 align="left">&nbsp;</h2>
		<h2 align="left"><span class="style1">Complaint Status</span></h2>
		<!-- [if IE] 
		...
		<script>
		 ...
		 $ss="select * from add_status";
		 $res=mysql_query($ss);
		 ?>
		  
		     <table width="200" border="1" align="center" bgcolor="#FFFFFF">
               <tr bgcolor="#999966">
                 <td><label for="checkbox_row_1">Complaint Id</label></td>
                 <td><label for="checkbox_row_2">Status</label></td>
                 <td><label for="checkbox_row_3">Photo</label></td>
                 <td>Activity</td>
               </tr>
               <?php
