			...
			<div id="navbar" class="navbar-collapse collapse">
				...
				<h1 style="text-align: center;"> <a href="#" ><i aria-hidden="true"></i> Admin Page </a></h1>
					...
					<ul class="nav navbar-nav">
												...
												<li class="active"><a href="staffdetails.php">Add Staff</a></li>
...
<div class="banner_bottom">
		<div class="container">
			<div class="tittle-w3ls_head">
				<h3 class="tittle-w3ls three">Staff Details<span></span></h3>
			</div>
			<div class="inner_sec_info_wthree_agile">
				<div class="signin-form">
                <script src="countries.js"> </script>
					<div class="login-form-rec">
           <form action="add_staffdetails.php" method="post" >
